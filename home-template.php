      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/web_development.svg" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/graphics_design.svg" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/seo_and_marketing.svg" alt="">
              </div>
              <h5>SEO & Marketing</h5>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/customer_services.svg" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/app_development.svg" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/ui_ux_design.svg" alt="">
              </div>
              <h5>UI/UX Design</h5>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/product_design.svg" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
            <div class="text-center">
              <div class="img-fluid mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/data_analyst.svg" alt="">
              </div>
              <h5>Data Analyst</h5>
            </div>
          </div>
        ...
        <div class="owl-carousel team-carousel mt-5">
          <div class="team-wrap">
            <div class="team-profile">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teams/team_1.jpg" alt="">
            </div>
          ...
          <div class="team-wrap">
            <div class="team-profile">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teams/team_2.jpg" alt="">
            </div>
            <div class="team-content">
          ...
          <div class="team-wrap">
            <div class="team-profile">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teams/team_3.jpg" alt="">
            </div>
            <div class="team-content">
              <h5>Anna Anderson</h5>
      ...
      <div class="container">
        ...
        <div class="row mt-3">
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-1.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-1.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-2.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-2.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-3.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-3.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-4.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-4.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-5.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-5.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="col-lg-4 py-3">
            <div class="portfolio">
              <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-6.jpg" data-fancybox="portfolio">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/work-6.jpg" alt="">
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="owl-carousel testimonial-carousel">
          ...
          <div class="card-testimonial">
            ...
            <div class="author">
              <div class="avatar">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/person/person_3.jpg" alt="">
              </div>
              <div class="d-inline-block ml-2">
